...
void identity::processInput(ifstream &inFile)
{ // seems fine. proper Nodes read in and show as present
...
identity::~identity()
{
  ...
  while (!isEmpty())
  {
    /*  std::cout << "Destructor looping..." << std::endl; */
